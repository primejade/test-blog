...
xref:syntax-02-numbers.adoc[numbers] and
xref:syntax-03-strings.adoc[strings],
...
xref:syntax-06-array.adoc[array], not
xref:syntax-07-hash.adoc[hashes]. In addition, the interpolation is
